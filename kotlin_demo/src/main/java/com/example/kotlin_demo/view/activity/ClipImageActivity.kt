...
import com.example.administrator.kotlin.ClipViewLayout
...
class ClipImageActivity : AppCompatActivity(), View.OnClickListener {
     ...
     */
    fun initView() {
        clipViewLayout1 = findViewById(R.id.clipViewLayout1) as ClipViewLayout
        clipViewLayout2 = findViewById(R.id.clipViewLayout2) as ClipViewLayout
        back = findViewById(R.id.iv_back) as ImageView
        btnCancel = findViewById(R.id.btn_cancel) as TextView
        btnOk = findViewById(R.id.bt_ok) as TextView
        //设置点击事件监听器
    ...
    override fun onResume() {
        super.onResume()
        Log.i(TAG, "image uri: " + intent.data)
        if (type == 1) {
    ...
    companion object {
        private val TAG = "ClipImageActivity"
    }
}
